...
export const NodeActionBar: React.FC<NodeActionBarProps> = ({
  ...
  return (
    <div className="node-header-actions" onMouseDown={(e) => e.stopPropagation()} onPointerDown={(e) => e.stopPropagation()}>
      {selected && (
        <div className="node-header-menu-wrapper">
          ...
          {isMenuOpen && (
            <>
              ...
              />
              <div onClick={(e) => e.stopPropagation()} onPointerDown={(e) => e.stopPropagation()} className="node-menu-popup">
                <button
                  type="button"
                  onMouseDown={(e) => {
                    e.preventDefault();
