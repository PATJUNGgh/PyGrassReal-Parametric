...
interface UnitXBodyProps {
    id: string;
    data: NodeData['data'];
    onDataChange: (id: string, data: Partial<NodeData['data']>) => void;
}

const UnitXBody: React.FC<UnitXBodyProps> = ({ id, data, onDataChange }) => {
...
export const UnitXNode: React.FC<UnitXNodeProps> = ({
    node,
    onPositionChange,
    onDataChange,
    onConnectionStart,
    ...
    const enhancedData = useMemo(() => {
        ...
        return {
            ...
            outputs,
            customName: node.data.customName || 'X',
