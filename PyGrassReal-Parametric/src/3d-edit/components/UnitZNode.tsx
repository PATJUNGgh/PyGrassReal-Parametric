...
interface UnitZBodyProps {
    id: string;
    data: NodeData['data'];
    onDataChange: (id: string, data: Partial<NodeData['data']>) => void;
}

const UnitZBody: React.FC<UnitZBodyProps> = ({ id, data, onDataChange }) => {
...
export const UnitZNode: React.FC<UnitZNodeProps> = ({
    node,
    onPositionChange,
    onDataChange,
    onConnectionStart,
    ...
    const enhancedData = useMemo(() => {
        ...
        return {
            ...
            outputs,
            customName: node.data.customName || 'Z',
