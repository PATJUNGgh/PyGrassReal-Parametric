...
export function updateMarchingCubesField(
    ...
    // Include both ends of the domain [-1, 1] to avoid boundary clipping artifacts.
    const step = 2.0 / Math.max(1, resolution - 1);
