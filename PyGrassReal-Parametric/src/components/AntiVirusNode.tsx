...
export const AntiVirusNode: React.FC<AntiVirusNodeProps> = ({
    id,
    data,
    position,
    selected,
    ...
    const customName = data.customName || 'AntiVirus Node';
        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    top: `${position.y}px`,
                    width: '280px',
                    background: 'linear-gradient(165deg, rgba(220, 38, 38, 0.85) 0%, rgba(255, 255, 255, 0.4) 100%)',
                    border: isInfected
                        ? '3px solid #ff0000'
                        : selected ? '3px solid #dc2626' : '1px solid rgba(255, 255, 255, 0.6)',
                    borderRadius: '16px',
                    boxShadow: isInfected
                        ...
                        : selected
                            ? '0 0 0 4px rgba(220, 38, 38, 0.4), 0 0 30px 5px rgba(220, 38, 38, 0.6), 0 10px 30px -5px rgba(0, 0, 0, 0.3), inset 0 0 20px rgba(220, 38, 38, 0.3)'
                            : '0 8px 32px rgba(220, 38, 38, 0.3), inset 0 0 0 1px rgba(255, 255, 255, 0.2)',
            ...
            >
                ...
                <div style={{ padding: '16px', display: 'flex', gap: '20px', position: 'relative' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255, 255, 255, 0.9)', letterSpacing: '0.5px', marginBottom: '4px' }}>
                            INPUTS
                        </div>
                        ...
                        {inputs.map((input) => {
                            ...
                            return (
                                <div key={input.id} style={{ position: 'relative', display: 'flex', alignItems: 'center', minHeight: '24px' }}>
                                    ...
                                    <span style={{ fontSize: '13px', color: 'rgba(255, 255, 255, 0.95)' }}>{input.label}</span>
                                    <button
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'flex-end' }}>
                        <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255, 255, 255, 0.9)', letterSpacing: '0.5px', marginBottom: '4px', textAlign: 'right', width: '100%' }}>
                            OUTPUTS
                        </div>
                        ...
                        {outputs.map((output) => {
                            ...
                            return (
                                <div key={output.id} style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', width: '100%', minHeight: '24px' }}>
                                    ...
                                    <span style={{ fontSize: '13px', color: 'rgba(255, 255, 255, 0.95)', marginRight: '10px' }}>{output.label}</span>
